...
export function TimeInput({ onTimeSet, disabled }: TimeInputProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">プレゼンテーション時間設定</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
          ...
          <div className="flex items-center justify-center space-x-4">
            <div className="text-center">
              <label htmlFor="minutes" className="block text-lg font-medium text-gray-700 mb-2">
                分
              </label>
              <input
                type="number"
            ...
            <div className="text-center">
              <label htmlFor="seconds" className="block text-lg font-medium text-gray-700 mb-2">
                秒
              </label>
              <input
                type="number"
          ...
          <div className="text-center mt-4 p-3 bg-white rounded-md border border-blue-300">
            ...
            <span className="text-sm text-blue-600 block mt-1">
              ({Math.floor(minutes + seconds / 60)}分{Math.floor(((minutes + seconds / 60) % 1) * 60)}秒)
            </span>
          </div>
        </div>
        ...
        <div className="bg-yellow-50 rounded-lg p-5 border border-yellow-200">
          <h3 className="text-lg font-semibold mb-4 text-gray-800 flex items-center">
            ...
            アラート設定
            <span className="text-sm font-normal text-gray-600 ml-2">(残り時間で通知)</span>
          </h3>
              ...
              <div className="flex items-center justify-center space-x-3">
                <div className="text-center">
                  <input
                    ...
                    max="999"
                    value={alert1Minutes}
                    onChange={(e) => setAlert1Minutes(Math.max(0, parseInt(e.target.value) || 0))}
                    disabled={disabled}
                ...
                <div className="text-center">
                  <input
                    ...
                    max="59"
                    value={alert1Seconds}
                    onChange={(e) => setAlert1Seconds(Math.max(0, Math.min(59, parseInt(e.target.value) || 0)))}
                    disabled={disabled}
                    className="w-16 px-2 py-2 text-lg font-medium text-center border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 bg-white"
                  />
              ...
              <div className="flex items-center justify-center space-x-3">
                <div className="text-center">
                  <input
                    ...
                    max="999"
                    value={alert2Minutes}
                    onChange={(e) => setAlert2Minutes(Math.max(0, parseInt(e.target.value) || 0))}
                    disabled={disabled}
                    className="w-16 px-2 py-2 text-lg font-medium text-center border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 bg-white"
                  />
                  <div className="text-xs text-gray-500 mt-1">分</div>
                ...
                <div className="text-center">
                  <input
                    ...
                    max="59"
                    value={alert2Seconds}
                    onChange={(e) => setAlert2Seconds(Math.max(0, Math.min(59, parseInt(e.target.value) || 0)))}
                    disabled={disabled}
                    className="w-16 px-2 py-2 text-lg font-medium text-center border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 bg-white"
                  />
                  <div className="text-xs text-gray-500 mt-1">秒</div>
              ...
              <div className="flex items-center justify-center space-x-3">
                <div className="text-center">
                  <input
                    ...
                    max="999"
                    value={alert3Minutes}
                    onChange={(e) => setAlert3Minutes(Math.max(0, parseInt(e.target.value) || 0))}
                    disabled={disabled}
                    className="w-16 px-2 py-2 text-lg font-medium text-center border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 bg-white"
                  />
                  <div className="text-xs text-gray-500 mt-1">分</div>
                ...
                <div className="text-center">
                  <input
                    ...
                    max="59"
                    value={alert3Seconds}
                    onChange={(e) => setAlert3Seconds(Math.max(0, Math.min(59, parseInt(e.target.value) || 0)))}
                    disabled={disabled}
                    className="w-16 px-2 py-2 text-lg font-medium text-center border-2 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 bg-white"
                  />
                  <div className="text-xs text-gray-500 mt-1">秒</div>
